...
('John', 'Doe', 'john.doe@example.com', '123-456-7890', 55000, 1),
('Jane', 'Smith', 'jane.smith@example.com', '987-654-3210', 65000, 2), 
('Michael', 'Johnson', 'michael.johnson@example.com', '555-123-4567', 75000, 3),
('Emily', 'Williams', 'emily.williams@example.com', '444-987-6543', 85000, 4),
('David', 'Brown', 'david.brown@example.com', '333-222-1111', 70000, 5);
